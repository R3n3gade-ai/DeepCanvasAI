...
<div class="settings-group">
    <label for="veo2AccessToken">Veo 2 Access Token (Required for video generation)</label>
    <input type="password" id="veo2AccessToken" placeholder="Enter your Vertex AI access token">
    <small class="field-note">For deepcanvas-ai project</small>
</div>

<div class="settings-group">
    <label for="veo2ApiUrl">Veo 2 API URL (Optional)</label>
    <input type="text" id="veo2ApiUrl" placeholder="Leave blank to use default API endpoint">
    <small class="field-note">Defaults to Vertex AI endpoint</small>
</div>

<div class="settings-group">
    <div class="collapsible" id="reactVideoEditorToggle">React Video Editor Integration ▼</div>
    <div class="collapsible-content">
        <div class="settings-group">
            <label for="reactVideoEditorUrl">React Video Editor URL</label>
            <input type="text" id="reactVideoEditorUrl" placeholder="http://localhost:3000">
            <small class="field-note">URL to the React Video Editor instance</small>
        </div>
    </div>
</div>

<div class="settings-group">
    <div class="collapsible" id="secondMeToggle">Second-Me Integration ▼</div>
    <div class="collapsible-content">
        <div class="settings-group">
            <label for="secondMeApiUrl">Second-Me API URL</label>
            <input type="text" id="secondMeApiUrl" placeholder="http://localhost:5000/api">
            <small class="field-note">The URL endpoint for Second-Me API (automatically uses app authentication)</small>
        </div>
        <div class="settings-group">
            <label for="secondMeAppUrl">Second-Me App URL</label>
            <input type="text" id="secondMeAppUrl" placeholder="https://second-me.ai">
            <small class="field-note">URL to open when model training button is clicked</small>
        </div>
    </div>
</div>
